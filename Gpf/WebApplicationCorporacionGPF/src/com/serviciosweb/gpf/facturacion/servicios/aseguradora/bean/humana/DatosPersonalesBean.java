...
@XmlType(propOrder = {"ti_tipoident", "ti_cedula", "ti_mail"
						, "ti_telefono", "ti_estado", "ti_autnumcont", "ti_codplan", "ti_autcodigo", "ti_nomplan"
						, "ti_fechinicontr"
						, "ti_codgenero"
						, "ti_contrato"
...
public class DatosPersonalesBean implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7512521695101941870L;
	...
	private String  ti_fechaNacimiento;
	private List<infoAdicBean> ti_infoAdic;
	private List<DependientesBean> rec_dependiente;
	...
	public String getTi_fechaNacimiento() {
		return ti_fechaNacimiento;
	}

	public void setTi_fechaNacimiento(String ti_fechaNacimiento) {
		this.ti_fechaNacimiento = ti_fechaNacimiento;
	}
	...
	public List<DependientesBean> getRec_dependiente() {
		return rec_dependiente;
	}

	public void setRec_dependiente(List<DependientesBean> rec_dependiente) {
