 ...
 */
@Entity
@Table(name="TB_LOG_FACTURA_DIGITAL" , schema="farmacias")
...
public class LogFactura implements Serializable {
	...
	@Id
	@SequenceGenerator(schema="farmacias", name = "seq_tb_log_factura_digital", sequenceName = "seq_tb_log_factura_digital", allocationSize = 1)
