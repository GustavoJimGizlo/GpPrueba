...
//	
  ...
  // @Schedule(second=ConstantesJobs.segundos, minute=ConstantesJobs.minute, hour=hour, dayOfWeek=dayOfWeek, dayOfMonth=dayOfMonth, month=month, year=year, info="integracion")
	...
	public String obtenerArchivo() throws IOException {
	
		log.error("Ingresa a funcion");
		DocumentUtil.createDirectory("/documento/260422");
		DocumentUtil.crearArchivoDirectorio("/documento/260422/2604229121090989082870100030200000002895658032311.xml","http://51.161.35.81:8001/latina_mail/static/description/Factura.xml" );
	...
	public String ConsumoWSCancelacion(VORequestCancelacion  request) {
