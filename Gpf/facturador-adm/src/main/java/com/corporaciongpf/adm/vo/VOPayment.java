...
public class VOPayment {
	...
	private String   authorizationBulletin;
	...
	public String getAuthorizationBulletin() {
		return authorizationBulletin;
	}
	public void setAuthorizationBulletin(String authorizationBulletin) {
		this.authorizationBulletin = authorizationBulletin;
	}
